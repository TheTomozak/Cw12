...
{
    public partial class s18969Context : DbContext
    {
        public s18969Context()
        {
        }

        public s18969Context(DbContextOptions<s18969Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18969;Integrated Security=True");
            }
        }
